    ...
    <div class="row">
        <div class="col-sm-8 pr-1">
            <div class="card p-2">
                ...
                <?= $form->field($model, 'recommendedPosts')->dropDownList(Posts::listMap('pages'), [
                    'multiple' => true,
            ...
            <div class="card mt-2 pl-2 pt-2 pr-2 pb-2">
                ...
                <div class="post-cover text-center mb-2">
                    <div class="cover-preview">
                        ...
                        <img class="img-thumbnail" src="<?= !empty($model->cover) ? '/uploads/pages/'.$model->cover : '/images/no-image.jpg' ?>">
                    </div>
                </div>
